...
const double CommonAlgorithms::TwoPi = 6.283185307179586;

void CommonAlgorithms::FFTAnalysis(double *AVal, double *FTvl, int Nvl, int Nft)
{
...
double CommonAlgorithms::RhythmSpectrumPower(double *spectrum, float frequency_step,
